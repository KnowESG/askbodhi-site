    ...
    <motion.div key="result" {...fadeUp} style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center' }}>
      ...
      >
        ...
        <div style={{ fontSize: 14, color: 'var(--color-stone-600, #57534E)', lineHeight: 1.8 }}>
          Our team will run a full analysis on <strong style={{ color: 'var(--color-charcoal, #1C1917)' }}>{answers.website || 'your domain'}</strong> including:
        </div>
        <ul style={{ fontSize: 14, color: 'var(--color-stone-600, #57534E)', lineHeight: 1.8, marginTop: 8, paddingLeft: 20 }}>
          <li>Domain authority &amp; backlink profile</li>
          <li>Keyword landscape &amp; ranking gaps</li>
          <li>Traffic architecture breakdown</li>
        ...
        <div style={{ marginTop: 14, paddingTop: 12, borderTop: '1px solid var(--color-stone-100, #F5F5F4)', fontSize: 13, color: 'var(--color-stone-600, #57534E)', lineHeight: 1.6 }}>
          Your personalised report will arrive within <strong style={{ color: 'var(--color-charcoal, #1C1917)' }}>24 hours</strong>.
        </div>
      </motion.div>
      ...
      >
        <strong style={{ color: 'var(--color-charcoal, #1C1917)', fontWeight: 600 }}>We&apos;ve captured your assessment.</strong> Our team will review your answers and send a detailed AI readiness report with specific gaps and opportunities.
      </motion.div>
